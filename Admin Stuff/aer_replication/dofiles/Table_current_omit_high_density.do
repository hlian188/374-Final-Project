************************************************************************************
* File Purpose: Analysis of house price data, 1995-2015, omit high density areas
* Output: Table SA5 "Boundary Effects on House Prices, Zoopla House Value Estimates, and Rental Prices 1995-2013, 2015"
************************************************************************************
...
*========================================================================
* Table SA5, columns 1-6: House sales and Zoopla combined
*========================================================================
...
* Eliminate density discontinuity because of buildings
* Marshall street buildings (Stirling Ct and City of Westminster dwellings buildings)
drop if post_code=="W1F 9BD"
drop if post_code=="W1F 9BE"
drop if post_code=="W1F 7BE"
drop if post_code=="W1F 7ER"

* 10 Richmond Mews building
drop if post_code=="W1D 3DD"

* Dufour's place building (Sandrigam Ct building)
drop if post_code=="W1F 7SL"
...
* Column 3: Polynomial and Controls
	* Poly order: 2 
	reg lnprice broad##c.dist_netw dist_cent flat dist_bomb year source2 ///
...
*========================================================================
* Table SA5, columns 7-9: House Rentals
*========================================================================
...
* Column 7: LLR with Controls
	rdrobust lnrentals dist_2, vce(nncluster pcode) covs(dist_bomb month_rented year bedrooms) all h(.491)
		est store tab10_7
		estadd scalar Obs = e(N_b_l) + e(N_b_r)
...
* Column 8: Semi: Polynomial and bandwidth
	* Poly order: 2 
	...
	if dist_netw<hopt_lnrental, cl(pcode)
		est store tab10_8
		estadd scalar Obs = e(N)
		estadd scalar Mean = mean_out_lnrental
