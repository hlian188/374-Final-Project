...
poly_rd_opt = c(mA3_coef, mA3_se, mA3_obs, mean_rentals53, 100,
                mB3_coef, mB3_se, mB3_obs, mean_rentals64, 100,
                mC3_coef, mC3_se, mC3_obs, mean_rentals94, 100,
                mD3_coef, mD3_se, mD3_obs, mean_rentals36, 100)
...
test = data.frame(
  ...
  `Polynomial RD Optimal Band` = poly_rd_opt,
  `Polynomial RD Wide Band` = poly_rd_wide,
  `Polynomial RD Segment FE` = poly_rd_segfe
)
