...
houses = read_dta("aer_replication/data/19th/houses_1853_final.dta")
=======
setwd("~/Econometrics 2/374-Final-Project/aer_replication/data/19th")
...
>>>>>>> 153e50d2b9afa3a6babc6204e4cc205c91c13053
```
...
```{r}
test = houses[complete.cases(houses), ]
```
...
for (i in 1:19) {
  ...
  rd_se_vec = append(rd_est_vec, m$se[1])
}
```
...
test = data.frame(
  Inside = in_all_mean,
  Outside = out_all_mean,
  SE = se_vec_full,
  Inside1 = in_100_mean,
  Outside1 = out_100_mean,
  SE1 = se_vec_full,
  RD_Est = rd_est_vec[1:19],
  RD_SE = rd_se_vec[1:19]
)
